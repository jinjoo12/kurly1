...
export default function Sub7AdminSignupComponent() {
    ...
    const onClickIdBtn=(e)=>{
        ...
        if(regexp2.test(value)===false || regexp3.test(value)===true || regexp4.test(value)===true  ||  regexp5.test(value)===false ){
            ...
            axios({
                url:'https://ljj4771.com/kurly/green_kurly_admin_id_duplicate_ok.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickEmailBtn=(e)=>{
        ...
        if(value===''){
            ...
            axios({
                url:'https://ljj4771.com/kurly/green_kurly_admin_email_duplicate_ok.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onSubmitForm=(e)=>{
        ...
        if(state.아이디===''){
            ...
            axios({
                url: 'https://ljj4771.com/kurly/green_kurly_admin_signup.php',
                method: 'POST',
