...
export default function Sub5SignUpComponent() {
    ...
    const onClickIdBtn=(e)=>{
        ...
        if(regexp2.test(value)===false || regexp3.test(value)===true || regexp4.test(value)===true  ||  regexp5.test(value)===false ){
            ...
            axios({
                url:'https://ljj4771.com/kurly/kurly_id_duplicate_ok.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickEmailBtn=(e)=>{
        ...
        if(value===''){
            ...
            axios({
                url:'https://ljj4771.com/kurly/kurly_email_duplicate_ok.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickIdOk=(e)=>{
        ...
        axios({
            url:'https://ljj4771.com/kurly/kurly_id_ok.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
    ...
    const onSubmitForm=(e)=>{
        ...
        if(state.아이디===''){
            ...
            // userId      아이디          ljj4771 
            // userPw      비밀번호        ljj4771123
            // userName    이름            이순신
            // userEmail   이메일          ljj4771@naver.com
            // userHp      휴대폰          01079425305
            // userAddress 주소            신촌로
            // userGender  성별            여성
            // userBirth   생년월일        1970 10 9
            // userAddInput 추가입력사항   친구초대 추천인 아이디 ljj4771
            ...
            axios({
                url: 'https://ljj4771.com/kurly/kurly_insert.php',
                method: 'POST',
